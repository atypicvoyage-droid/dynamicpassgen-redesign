        ...
        {featuredGuide && (
          <section className="mb-16">
            ...
            <a 
              ...
              className="block bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-[1.01]"
            >
              ...
              <div className="relative">
                {featuredGuide.image ? (
                  <div className="relative h-64 md:h-80">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-blue-900/95 via-purple-900/70 to-transparent" />
                  </div>
                ) : (
                  <div className="h-64 md:h-80 bg-gradient-to-br from-blue-500 to-purple-600" />
                )}
