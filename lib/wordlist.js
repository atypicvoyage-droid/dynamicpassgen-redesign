...
// Based on EFF Short Wordlist + Supplemental words for better entropy
// Total entropy per word: ~11 bits
// 4 words = ~44 bits (Strong)
// 5 words = ~55 bits (Very Strong)
// 6 words = ~66 bits (Excellent)

export const WORD_LIST = [
  "abacus", "abdomen", "abdominal", "abide", "ability", "ablaze", "able", "abnormal", "abrasion", "abrasive",
  "absence", "absent", "absorb", "abstract", "absurd", "accent", "accept", "access", "accessory", "accident",
  ...
  "baggage", "bait", "baker", "balance", "ball", "balloon", "bamboo", "banana", "band", "bandage",
  "bang", "bank", "banner", "bar", "barely", "bargain", "bark", "barn", "barrel", "base",
  "basic", "basil", "basket", "bat", "bath", "battery", "battle", "beach", "bean", "bear",
  "beard", "beast", "beat", "beauty", "become", "beef", "beer", "beetle", "before", "begin",
  ...
  "boy", "bracket", "brain", "brand", "brass", "brave", "bread", "break", "breakfast", "breath",
  "breeze", "brick", "bridge", "brief", "bright", "bring", "brisk", "broccoli", "broken", "bronze",
  "broom", "brother", "brown", "brush", "bubble", "buddy", "budget", "buffalo", "build", "bulb",
  "bulk", "bullet", "bundle", "bunker", "burden", "burger", "burst", "bus", "business", "busy",
  "butter", "buyer", "buzz", "cabbage", "cabin", "cable", "cactus", "cage", "cake", "call",
  "calm", "camera", "camp", "can", "canal", "cancel", "candy", "cannon", "canoe", "canvas",
  "canyon", "cap", "capital", "captain", "car", "carbon", "card", "cargo", "carpet", "carry",
  "cart", "case", "cash", "casino", "castle", "casual", "cat", "catalog", "catch", "category",
  "cattle", "caught", "cause", "caution", "cave", "ceiling", "celery", "cement", "census", "century",
  "cereal", "certain", "chair", "chalk", "champion", "change", "chaos", "chapter", "charge", "chase",
  "chat", "cheap", "check", "cheese", "chef", "cherry", "chest", "chicken", "chief", "child",
  "chimney", "choice", "choose", "chronic", "chunk", "churn", "cigar", "cinnamon", "circle", "citizen",
  ...
  "course", "cousin", "cover", "cow", "crack", "cradle", "craft", "cram", "crane", "crash",
  ...
  "lack", "lady", "lake", "lamp", "language", "laptop", "large", "last", "late", "later",
  ...
  "palace", "palm", "pan", "panel", "panic", "panther", "paper", "parade", "parent", "park",
  ...
  "picnic", "picture", "piece", "pig", "pigeon", "pile", "pilot", "pill", "pillow", "pin",
  "pine", "ping", "pink", "pipe", "pistol", "pitch", "pizza", "place", "planet", "plastic",
  "plate", "play", "please", "pledge", "pluck", "plug", "plunge", "poem", "poet", "point",
  "polar", "pole", "police", "pond", "pony", "pool", "popular", "portion", "position", "positive",
  ...
  "night", "tool", "tooth", "top", "topic", "topple", "torch", "tornado", "tortoise", "toss",
